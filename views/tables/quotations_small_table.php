...
foreach ($rResult as $aRow) {
    ...
    //$numberOutput = '<a href="' . admin_url('quotations/list_quotations/' . $aRow[db_prefix() . 'quotations.id']) . '" onclick="init_quotation(' . $aRow[db_prefix() . 'quotations.id'] . '); return false;">' . format_quotation_number($aRow[db_prefix() . 'quotations.id']) . '</a>';
    $numberOutput = '<a href="' . admin_url('quotations/list_quotations/' . $aRow[db_prefix() . 'quotations.id']) . '" onclick="init_quotation(' . $aRow[db_prefix() . 'quotations.id'] . '); return false;">' . format_quotation_number($aRow[db_prefix() . 'quotations.id']) . '</a>';
