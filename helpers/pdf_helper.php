 ...
 * Additional quotations applied because this function wont work on all servers. All depends how the server is configured.
 * @return string
 */
 ...
 * @param  string $type   document type e.q. payment, quotation, invoice
